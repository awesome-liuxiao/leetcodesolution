...
class Solution:
    def findSubstring(self, s: str, words: List[str]) -> List[int]:
        ...
        #     tmp = []
        #     tmpStr = ""
        #     for p in range(i, i+wordsLen):
        #         tmpStr += s[p]
        #     tmp = [''.join(x) for x in zip(*[list(tmpStr[z::singleLen]) for z in range(singleLen)])]
        #     tmp.sort()
        #     print(tmp)
        #     if tmp == words:
        #         res.append(i)
